...
class Ui_playerWindow(object):
    def setupUi(self, playerWindow):
        ...
        playerWindow.setMinimumSize(QtCore.QSize(400, 400))
        playerWindow.setMaximumSize(QtCore.QSize(400, 400))
        self.playbackBar = QtWidgets.QSlider(parent=playerWindow)
        self.playbackBar.setGeometry(QtCore.QRect(20, 260, 361, 22))
        self.playbackBar.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.playbackBar.setObjectName("playbackBar")
        self.coverPhoto = QtWidgets.QLabel(parent=playerWindow)
        self.coverPhoto.setGeometry(QtCore.QRect(70, 30, 251, 221))
        self.coverPhoto.setFocusPolicy(QtCore.Qt.FocusPolicy.WheelFocus)
        self.coverPhoto.setText("")
        self.coverPhoto.setScaledContents(True)
        self.coverPhoto.setOpenExternalLinks(False)
        self.coverPhoto.setObjectName("coverPhoto")
        self.backButton = QtWidgets.QPushButton(parent=playerWindow)
        self.backButton.setGeometry(QtCore.QRect(30, 290, 93, 28))
        self.backButton.setObjectName("backButton")
        self.playButton = QtWidgets.QPushButton(parent=playerWindow)
        self.playButton.setGeometry(QtCore.QRect(150, 290, 93, 28))
        self.playButton.setObjectName("playButton")
        self.forwardButton = QtWidgets.QPushButton(parent=playerWindow)
        self.forwardButton.setGeometry(QtCore.QRect(280, 290, 93, 28))
        self.forwardButton.setObjectName("forwardButton")
        self.pauseButton = QtWidgets.QPushButton(parent=playerWindow)
        self.pauseButton.setGeometry(QtCore.QRect(150, 340, 93, 28))
